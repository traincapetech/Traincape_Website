...
<>
         ...
         <Helmet>
                <title>ISO/IEC 38500 IT Governance Training and Certification</title>
                <meta
                  name="description"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-teal-50 to-teal-100">
      <motion.section 
        ...
        animate="visible"
        variants={fadeInUp}
        className="relative bg-gradient-to-r from-teal-700 via-cyan-700 to-sky-700 text-white py-20 px-6 overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              >
                Master IT Governance Excellence
              </motion.p>
              <motion.p 
                initial={{ opacity: 0, x: -50 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                ISO/IEC 38500 provides principles for effective, efficient, and acceptable use of IT within organizations. Learn to govern IT for organizational success.
              </motion.p>
              <motion.div 
              ...
              >
                ...
                <button 
                  onClick={() => navigate("/test", { state: { course: "PECB", subTopic: "ISO38500ITGovernance", level: "easy" } })}
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <MdSecurity className="text-teal-600 text-4xl mb-4" />
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all"
            >
              <FaChartLine className="text-teal-600 text-4xl mb-4" />
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all"
            >
              <FaAward className="text-teal-600 text-4xl mb-4" />
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-teal-700 via-cyan-700 to-sky-700 text-white">
...
export default IEC38500ITGovernance;