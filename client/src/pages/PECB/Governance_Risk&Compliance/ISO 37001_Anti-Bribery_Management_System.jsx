...
const ISO37001AntiBriberyManagementSystem = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
        PECB ISO 37001 Training and Certification | IT Training & Certifications
        </title>
        <meta
          name="description"
        ...
        />
        <link rel="canonical" href="https://traincapetech.in/pecb/governance/iso-37001" />
      </Helmet>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="flex-1">
                ...
                >
                  ...
                  management system to prevent, detect, and address bribery.
                  Learn to establish a culture of integrity and compliance.
                </motion.p>
                <motion.div
...
export default ISO37001AntiBriberyManagementSystem;
