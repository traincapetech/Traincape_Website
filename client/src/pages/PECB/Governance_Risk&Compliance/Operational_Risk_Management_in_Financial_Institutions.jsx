        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              >
                Learn to identify, assess, and manage operational risks in financial institutions. Master Basel III requirements and risk management frameworks for banking operations.
              </motion.p>
              <motion.div 
