        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              >
                Learn to conduct effective internal audits of management systems. Master audit planning, execution, reporting, and follow-up for various management system standards.
              </motion.p>
              <motion.div 
