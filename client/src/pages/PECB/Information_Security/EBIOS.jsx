...
const EBIOSRiskManager = () => {
  ...
  const courseDetails = {
    examCode: "EBIOS Risk Manager",
    duration: "3 days (24 hours)",
    level: "Foundation",
    prerequisites: "Basic understanding of risk management",
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-white/20">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-teal-100">Certification</p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-3">Methodology Expertise</h3>
              <p className="text-gray-600">Apply EBIOS best practices and techniques</p>
            </motion.div>
          </div>
        </div>
      </section>
...
export default EBIOSRiskManager;
