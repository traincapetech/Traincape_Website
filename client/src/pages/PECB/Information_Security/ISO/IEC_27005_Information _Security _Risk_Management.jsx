...
const IEC27005InformationSecurityRiskManagement = () => {
  ...
  const keyDomains = [
    ...
    {
      icon: <MdAssessment />,
      title: "Risk Communication & Monitoring",
      topics: [
  ...
  const skills = [
    {
      icon: <FaExclamationTriangle />,
      title: "Risk Assessment",
      desc: "Conduct comprehensive information security risk assessments"
    },
    {
      icon: <FaChartLine />,
      title: "Risk Analysis",
      desc: "Analyze and evaluate information security risks"
    },
    {
      icon: <FaShieldAlt />,
      title: "Risk Treatment",
      desc: "Develop and implement risk treatment strategies"
    },
    {
      icon: <BsGraphUp />,
      title: "Career Growth",
      desc: "Qualify for information security risk management roles"
    }
  ];
  ...
  const trainingOutline = [
    "Day 1: Introduction to ISO 27005 and information security risk management",
    "Day 2: Risk assessment process and methodologies",
    "Day 3: Risk treatment, communication, monitoring, and certification exam"
  ];
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Comprehensive information security risk management training</p>
          </motion.div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-orange-50 to-red-50">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Information Security Risk Types</h2>
            <p className="text-xl text-gray-600">Comprehensive coverage of information security risks</p>
          </motion.div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-red-50 to-orange-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Focused information security risk management training</p>
          </motion.div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Professional information security risk management competencies</p>
          </motion.div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-orange-50 to-red-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Information security risk management roles</p>
          </motion.div>
          ...
          >
            ...
            <p className="mt-2 text-orange-100">Information security risk management positions</p>
          </motion.div>
        </div>
      </section>
...
export default IEC27005InformationSecurityRiskManagement;
