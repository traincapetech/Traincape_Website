        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              >
                Master Network Security Management
              </motion.p>
              <motion.p 
                initial={{ opacity: 0, x: -50 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                ISO/IEC 27033 provides guidance for network security management. Learn to design, implement, and manage secure network architectures and controls.
              </motion.p>
              <motion.div 
              ...
              >
                ...
                <button 
                  onClick={() => navigate("/test", { state: { course: "PECB", subTopic: "ISO27033NetworkSecurity", level: "easy" } })}
...
export default IEC27033NetworkSecurity;
