...
const ComputerForensics = () => {
  ...
  const courseDetails = {
    examCode: "PECB Computer Forensics",
    duration: "5 days (40 hours)",
    level: "Professional",
    prerequisites: "Basic understanding of cybersecurity and computer systems",
  ...
  const keyDomains = [
    {
      ...
      topics: [
        "Evidence acquisition methodologies",
  ...
  const skills = [
    {
      ...
      desc: "Properly collect and preserve digital evidence"
    },
    {
      icon: <FaLaptop />,
      title: "Forensic Analysis",
      desc: "Analyze digital evidence using forensic tools"
    },
    {
      icon: <FaShieldAlt />,
      title: "Investigation",
      desc: "Conduct comprehensive digital investigations"
    },
    {
      icon: <BsGraphUp />,
      title: "Career Growth",
      desc: "Qualify for digital forensics specialist roles"
    }
  ];
  ...
  const trainingOutline = [
    "Day 1: Introduction to computer forensics and digital evidence",
    "Day 2: Evidence collection and acquisition methodologies",
    "Day 3: Forensic analysis techniques and tools",
    "Day 4: Advanced investigation techniques and malware analysis",
    "Day 5: Legal procedures, reporting, and certification exam"
  ];

  const forensicTools = [
    "FTK Imager", "Autopsy", "Volatility", "Wireshark", "Sleuth Kit", "Cellebrite", "X-Ways Forensics", "EnCase"
  ];
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              >
                Master Digital Forensics & Cybercrime Investigation
              </motion.p>
              <motion.p 
                initial={{ opacity: 0, x: -50 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                Become a certified computer forensics professional with comprehensive training in digital evidence collection, analysis, and cybercrime investigation.
              </motion.p>
              <motion.div 
              ...
              >
                ...
                <button 
                  onClick={() => navigate("/test", { state: { course: "PECB", subTopic: "ComputerForensics", level: "easy" } })}
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">Computer Forensics Pro</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Comprehensive computer forensics training</p>
          </motion.div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-purple-50 to-indigo-50">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Industry-Standard Forensic Tools</h2>
            <p className="text-xl text-gray-600">Master the tools used by professional digital forensics investigators</p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {forensicTools.map((tool, idx) => (
              <motion.div
                key={idx}
                initial="hidden"
                whileInView="visible"
              ...
              >
                <FaLaptop className="text-purple-600 text-3xl mx-auto mb-3" />
                <h3 className="text-lg font-bold text-gray-800">{tool}</h3>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Digital Evidence Types</h2>
            <p className="text-xl text-gray-600">Comprehensive coverage of digital evidence sources</p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {evidenceTypes.map((evidence, idx) => (
              <motion.div
                key={idx}
                initial="hidden"
                whileInView="visible"
              ...
              >
                <FaSearch className="text-purple-600 text-3xl mb-4" />
                <h3 className="text-lg font-bold text-gray-800">{evidence}</h3>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-indigo-50 to-purple-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Comprehensive computer forensics curriculum</p>
          </motion.div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Professional computer forensics competencies</p>
          </motion.div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-purple-50 to-indigo-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Digital forensics and cybercrime investigation roles</p>
          </motion.div>
          ...
          >
            ...
            <p className="mt-2 text-purple-100">Digital forensics specialist positions</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-purple-700 via-indigo-700 to-blue-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            variants={fadeInUp}
          >
            <h2 className="text-4xl font-bold mb-4">Become a Computer Forensics Expert</h2>
            <p className="text-xl mb-8">Start your digital forensics career today</p>
