        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              >
                Master CMMC Framework & Compliance
              </motion.p>
              <motion.p 
                initial={{ opacity: 0, x: -50 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                CMMC is a unified standard for implementing cybersecurity across the defense industrial base. Learn to assess and implement CMMC practices for protecting Controlled Unclassified Information.
              </motion.p>
              <motion.div 
              ...
              >
                ...
                <button 
                  onClick={() => navigate("/test", { state: { course: "PECB", subTopic: "CMMC", level: "easy" } })}
...
export default CybersecurityMaturityModelCertificationCMMC;
