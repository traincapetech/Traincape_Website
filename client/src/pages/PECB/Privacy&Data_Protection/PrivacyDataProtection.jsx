  ...
  const certifications = [
    {
      ...
      description: "Master GDPR compliance and data protection requirements for EU data privacy regulations",
      duration: "3 days",
      level: "Foundation",
    //   price: "$800",
      url: "/pecb/privacy/gdpr",
      color: "from-pink-500 to-rose-500",
      keyTopics: ["GDPR Requirements", "Data Subject Rights", "Privacy by Design", "DPO Responsibilities"]
    },
    {
      icon: <FaUserShield />,
      title: "ISO/IEC 27701 Privacy Information Management System",
      description: "Implement privacy information management systems extending ISO 27001 for data protection",
      duration: "5 days",
      level: "Lead Auditor/Implementer",
      // price: "$1,200",
      url: "/pecb/privacy/iso-27701",
      color: "from-purple-500 to-pink-500",
      keyTopics: ["Privacy Controls", "PIMS Implementation", "Data Protection", "Privacy Risk Management"]
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-pink-50 to-rose-50">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              >
                Comprehensive privacy and data protection certifications covering GDPR, privacy management systems, and data protection best practices.
              </motion.p>
              <motion.div 
      ...
      <section className="py-4 px-6 bg-white border-b">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center space-x-2 text-sm">
            <button onClick={() => navigate("/")} className="text-pink-600 hover:text-pink-800">Home</button>
            <span className="text-gray-400">/</span>
            <button onClick={() => navigate("/PECB")} className="text-pink-600 hover:text-pink-800">PECB</button>
            <span className="text-gray-400">/</span>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Privacy & Data Protection Certifications</h2>
            <p className="text-xl text-gray-600">Choose your specialization and advance your privacy career</p>
          </motion.div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-pink-50 to-rose-50">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Why Choose Privacy & Data Protection?</h2>
            <p className="text-xl text-gray-600">Critical skills for the digital age</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600">Privacy professionals earn $80,000 - $130,000+ annually</p>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-3">Growing Field</h3>
                <p className="text-gray-600">Data protection roles growing rapidly worldwide</p>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-3">Global Regulations</h3>
                <p className="text-gray-600">Critical for compliance in all industries</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-pink-700 via-rose-700 to-purple-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            variants={fadeInUp}
          >
            <h2 className="text-4xl font-bold mb-4">Start Your Privacy & Data Protection Journey</h2>
            <p className="text-xl mb-8">Choose from our comprehensive range of privacy certifications</p>
