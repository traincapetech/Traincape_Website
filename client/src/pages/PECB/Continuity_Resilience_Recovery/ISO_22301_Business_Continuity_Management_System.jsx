...
const ISO22301BusinessContinuityManagementSystem = () => {
  ...
  const courseDetails = {
    examCode: "ISO 22301:2019",
    duration: "5 days (40 hours)",
    level: "Lead Implementer/Auditor",
    prerequisites: "Understanding of business continuity concepts",
  ...
  const skills = [
    {
      icon: <FaExclamationTriangle />,
      title: "BCMS Implementation",
      desc: "Implement business continuity management systems"
    },
    {
      icon: <FaChartLine />,
      title: "Risk Management",
      desc: "Conduct business impact analysis"
    },
    {
      icon: <FaShieldAlt />,
      title: "Crisis Management",
      desc: "Develop crisis response capabilities"
    },
    {
      icon: <BsGraphUp />,
      title: "Career Growth",
      desc: "Qualify for senior business continuity roles"
    }
  ];
  ...
  const trainingOutline = [
    "Day 1: Introduction to ISO 22301 and BCMS concepts",
    "Day 2: Business impact analysis and risk assessment",
    "Day 3: Business continuity strategy and planning",
    "Day 4: BCMS implementation and operation",
    "Day 5: Performance evaluation, improvement, and certification exam"
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-yellow-50 to-orange-50">
      ...
      <motion.section 
        ...
        animate="visible"
        variants={fadeInUp}
        className="relative bg-gradient-to-r from-yellow-700 via-orange-700 to-red-700 text-white py-20 px-6 overflow-hidden"
      >
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Comprehensive BCMS training across 4 key areas</p>
          </motion.div>
            ...
            {keyDomains.map((domain, idx) => (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="text-4xl text-yellow-600">{domain.icon}</div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-yellow-50 to-orange-50">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-gray-800 mb-4">BCMS Implementation Phases</h2>
            <p className="text-xl text-gray-600">5-phase approach to BCMS implementation</p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {bcmsPhases.map((phase, idx) => (
              <motion.div
                key={idx}
                initial="hidden"
                whileInView="visible"
              ...
              >
                <div className="bg-gradient-to-r from-yellow-600 to-orange-600 text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-xl mx-auto mb-4">
                  {idx + 1}
                </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Business Continuity Strategies</h2>
            <p className="text-xl text-gray-600">Key continuity strategies for organizational resilience</p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {continuityStrategies.map((strategy, idx) => (
              <motion.div
                key={idx}
                initial="hidden"
                whileInView="visible"
              ...
              >
                ...
                <h3 className="text-lg font-bold text-gray-800">{strategy}</h3>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-orange-50 to-yellow-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Structured BCMS implementation curriculum</p>
          </motion.div>
          ...
          <div className="grid gap-4 max-w-4xl mx-auto">
            {trainingOutline.map((day, idx) => (
              <motion.div
                ...
                variants={fadeInUp}
                transition={{ delay: idx * 0.1 }}
                className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all border-l-4 border-yellow-600"
              >
                <div className="flex items-center gap-4">
                  <div className="bg-gradient-to-r from-yellow-600 to-orange-600 text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-xl flex-shrink-0">
                    {idx + 1}
                  </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Professional BCMS competencies</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {skills.map((skill, idx) => (
              ...
              >
                <div className="text-4xl text-yellow-600 mb-4">{skill.icon}</div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-yellow-50 to-orange-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Business continuity leadership roles</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {careerPaths.map((career, idx) => (
              <motion.div
                ...
                variants={fadeInUp}
                transition={{ delay: idx * 0.1 }}
                className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 border-l-4 border-yellow-600"
              >
                <FaUserTie className="text-yellow-600 text-2xl mb-3" />
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            variants={fadeInUp}
            className="mt-12 bg-gradient-to-r from-yellow-600 to-orange-600 text-white rounded-2xl p-8 text-center"
          >
            <h3 className="text-2xl font-bold mb-3">Average Salary Range</h3>
            <p className="text-4xl font-bold">$80,000 - $125,000</p>
            <p className="mt-2 text-yellow-100">Senior business continuity positions</p>
          </motion.div>
        </div>
      </section>

      {/* CTA Section */}
      <section className="py-16 px-6 bg-gradient-to-r from-yellow-700 via-orange-700 to-red-700 text-white">
...
export default ISO22301BusinessContinuityManagementSystem;
