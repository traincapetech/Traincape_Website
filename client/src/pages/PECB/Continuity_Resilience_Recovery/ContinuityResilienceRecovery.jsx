  ...
  const certifications = [
    {
      ...
      description: "Master business continuity management with the international standard for BCM implementation",
      duration: "5 days",
      level: "Lead Auditor/Implementer",
      // price: "$1,200",
      url: "/pecb/continuity/iso-22301",
      color: "from-blue-500 to-cyan-500",
      keyTopics: ["BCM Framework", "Business Impact Analysis", "Recovery Strategies", "Testing & Exercises"]
    },
    {
      icon: <FaExclamationTriangle />,
      title: "Crisis Management Professional",
      description: "Learn to manage organizational crises effectively with planning, response, and recovery strategies",
      duration: "5 days",
      level: "Professional",
      // price: "$1,200",
      url: "/pecb/continuity/crisis-management",
      color: "from-amber-500 to-orange-500",
      keyTopics: ["Crisis Planning", "Response Coordination", "Communication", "Post-Crisis Recovery"]
    },
    {
      icon: <FaShieldAlt />,
      title: "Digital Operational Resilience Act (DORA)",
      description: "Master EU DORA requirements for digital operational resilience in financial services",
      duration: "5 days",
      level: "Professional",
      // price: "$1,200",
      url: "/pecb/continuity/dora",
      color: "from-sky-500 to-blue-500",
      keyTopics: ["ICT Risk Management", "Incident Reporting", "Resilience Testing", "Third-Party Risk"]
    },
    {
      icon: <FaRedo />,
      title: "Disaster Recovery Professional",
      description: "Develop comprehensive disaster recovery plans for business continuity and critical operations",
      duration: "5 days",
      level: "Professional",
      // price: "$1,200",
      url: "/pecb/continuity/disaster-recovery",
      color: "from-rose-500 to-red-500",
      keyTopics: ["Recovery Planning", "Testing Methodologies", "Recovery Strategies", "Business Continuity"]
    },
    {
      icon: <FaChartLine />,
      title: "Operational Resilience Management",
      description: "Build and maintain operational resilience for organizations with comprehensive planning",
      duration: "5 days",
      level: "Professional",
      // price: "$1,200",
      url: "/pecb/continuity/operational-resilience",
      color: "from-violet-500 to-purple-500",
      keyTopics: ["Resilience Planning", "Impact Assessment", "Recovery Strategies", "Business Continuity"]
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-cyan-50">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">5 Available</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">BCM & Resilience Leadership</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-4 px-6 bg-white border-b">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-600">Continuity, Resilience & Recovery</span>
          </nav>
        </div>
      </section>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Continuity, Resilience & Recovery Certifications</h2>
            <p className="text-xl text-gray-600">Choose your specialization and advance your BCM career</p>
          </motion.div>
...
export default ContinuityResilienceRecovery;
