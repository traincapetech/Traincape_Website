  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-orange-50 to-orange-100">
      <Helmet>
        ...
        <link rel="canonical" href="https://www.traincapetech.in/pecb/technical-cybersecurity/incident-response" />
      </Helmet>
      <motion.section 
        initial="hidden"
        animate="visible"
        variants={fadeInUp}
        className="relative bg-gradient-to-r from-orange-700 via-amber-700 to-yellow-700 text-white py-20 px-6 overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              >
                Master Cyber Incident Response
              </motion.p>
              <motion.p 
                initial={{ opacity: 0, x: -50 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                Learn to respond to and manage cybersecurity incidents effectively. Master incident detection, containment, eradication, recovery, and post-incident analysis.
              </motion.p>
              <motion.div 
              ...
              >
                ...
                <button 
                  onClick={() => navigate("/test", { state: { course: "PECB", subTopic: "IncidentResponse", level: "easy" } })}
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <MdSecurity className="text-orange-600 text-4xl mb-4" />
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all"
            >
              <FaAward className="text-orange-600 text-4xl mb-4" />
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-orange-700 via-amber-700 to-yellow-700 text-white">
