  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-red-50 to-red-100">
      <motion.section 
        ...
        animate="visible"
        variants={fadeInUp}
        className="relative bg-gradient-to-r from-red-700 via-crimson-700 to-rose-700 text-white py-20 px-6 overflow-hidden"
      >
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-red-700 via-crimson-700 to-rose-700 text-white">
...
export default CertifiedCyberThreatAnalystCCTA;
