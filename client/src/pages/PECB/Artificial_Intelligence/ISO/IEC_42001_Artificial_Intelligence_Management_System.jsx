...
const IEC42001ArtificialIntelligenceManagementSystem = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-purple-100">
      <motion.section 
        ...
        animate="visible"
        variants={fadeInUp}
        className="relative bg-gradient-to-r from-purple-700 via-violet-700 to-indigo-700 text-white py-20 px-6 overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              >
                Master AI Management Excellence
              </motion.p>
              <motion.p 
                initial={{ opacity: 0, x: -50 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                ISO/IEC 42001 is the international standard for AI management systems. Learn to implement responsible AI practices, governance frameworks, and risk management for AI systems.
              </motion.p>
              <motion.div 
              ...
              >
                ...
                <button 
                  onClick={() => navigate("/test", { state: { course: "PECB", subTopic: "ISO42001AIManagement", level: "easy" } })}
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-purple-700 via-violet-700 to-indigo-700 text-white">
...
export default IEC42001ArtificialIntelligenceManagementSystem;
