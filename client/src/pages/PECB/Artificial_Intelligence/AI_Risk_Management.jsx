  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-fuchsia-50 to-fuchsia-100">
      <motion.section 
        ...
        animate="visible"
        variants={fadeInUp}
        className="relative bg-gradient-to-r from-fuchsia-700 via-purple-700 to-pink-700 text-white py-20 px-6 overflow-hidden"
      >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              <motion.p 
                ...
                className="text-xl md:text-2xl mb-6 text-fuchsia-100"
              >
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-white/20">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-fuchsia-100">Standard</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-fuchsia-100">Duration</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-fuchsia-100">Level</p>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <MdSecurity className="text-fuchsia-600 text-4xl mb-4" />
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all"
            >
              <FaChartLine className="text-fuchsia-600 text-4xl mb-4" />
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all"
            >
              <FaAward className="text-fuchsia-600 text-4xl mb-4" />
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-fuchsia-700 via-purple-700 to-pink-700 text-white">
