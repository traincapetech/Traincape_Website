...
const IEC17025LaboratoryManagementSystem = () => {
  ...
  const courseDetails = {
    ...
    prerequisites:
      "Understanding of laboratory operations and quality management",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50 to-purple-50">
      <Helmet>
        <title>
          PECB ISO/IEC 17025 Certification | Laboratory Management System{" "}
        </title>
        <meta
          name="description"
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              >
                ISO/IEC 17025 is the international standard for testing and
                calibration laboratories. Master technical competence,
                measurement uncertainty, and quality assurance for accredited
                ...
                <button
                  onClick={() =>
                    navigate("/test", {
                      state: {
                        course: "PECB",
                        subTopic: "ISO17025LaboratoryManagement",
                        level: "easy",
                      },
                    })
                  }
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Comprehensive laboratory management training
            </p>
          </motion.div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-indigo-50 to-purple-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              Laboratory Accreditation Benefits
            </h2>
            <p className="text-xl text-gray-600">
              Achieve international recognition and competence
            </p>
          </motion.div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Structured learning path to laboratory management certification
            </p>
          </motion.div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-purple-50 to-indigo-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Professional laboratory management competencies
            </p>
          </motion.div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Laboratory management leadership roles
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="mt-2 text-indigo-100">
              Senior laboratory management positions
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-4xl font-bold mb-4">
              Master Laboratory Management Excellence
            </h2>
            <p className="text-xl mb-8">
              Start your journey to becoming an ISO/IEC 17025 expert
            </p>
