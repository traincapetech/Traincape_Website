...
const DigitalTransformation = () => {
  ...
  const courseDetails = {
    examCode: "Digital Transformation",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-cyan-50 to-cyan-100">
      <SEOHead
        title="PECB Digital Transformation Certification Training - Traincape Technology"
        description="Get PECB Digital Transformation certified. Master digital transformation strategies and implementation."
        canonical="https://www.traincapetech.in/pecb/digital-transformation"
      />
      <motion.section 
        initial="hidden"
        animate="visible"
        variants={fadeInUp}
        className="relative bg-gradient-to-r from-cyan-700 via-sky-700 to-blue-700 text-white py-20 px-6 overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              >
                Learn to lead digital transformation initiatives in organizations. Master digital strategy, change management, innovation frameworks, and technology adoption for business success.
              </motion.p>
              <motion.div 
              ...
              >
                ...
                <button 
                  onClick={() => navigate("/test", { state: { course: "PECB", subTopic: "DigitalTransformation", level: "easy" } })}
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-white/20">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-cyan-100">Standard</p>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <MdSecurity className="text-cyan-600 text-4xl mb-4" />
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all"
            >
              <FaChartLine className="text-cyan-600 text-4xl mb-4" />
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl transition-all"
            >
              <FaAward className="text-cyan-600 text-4xl mb-4" />
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-cyan-700 via-sky-700 to-blue-700 text-white">
