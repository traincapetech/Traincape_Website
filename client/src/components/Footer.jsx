...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-950 text-white font-sans">
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-10 lg:px-12 pt-10 pb-8 border-b border-blue-700/30">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="flex items-start p-4 bg-slate-900 rounded-lg shadow-xl border border-transparent hover:border-blue-700 transition-all duration-500 group">
            ...
            <div className="ml-4">
              <h3 className="font-extrabold text-sm md:text-lg mb-2 text-blue-50 tracking-wide">
                {t.contactUs}
              </h3>
          ...
          <div className="flex items-start p-4 bg-slate-900 rounded-lg shadow-xl border border-transparent hover:border-blue-700 transition-all duration-500 group">
            ...
            <div className="ml-4">
              ...
              <p className="text-blue-400 font-semibold text-xs md:text-sm mt-1">
                {t.sundayClosed}
              </p>
            </div>
          </div>
      ...
      {/* Copyright */}
      <div className="bg-slate-900 mx-auto px-4 text-center py-4 flex flex-col items-center gap-2">
