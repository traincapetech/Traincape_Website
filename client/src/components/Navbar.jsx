...
const Navbar = () => {
  ...
  return (
    <>
      ...
      `}</style>
      <nav className="bg-gray-950 sticky top-0 z-30 lg:h-20 h-24 md:px-0 lg:px-12 px-4 flex items-center" aria-label="Main Navigation" style={{ fontFamily: 'Inter, sans-serif' }}>
