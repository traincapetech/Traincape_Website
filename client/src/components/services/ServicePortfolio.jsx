        ...
        {relatedProjects.map((proj) => (
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-[10px] text-blue-450 font-bold uppercase tracking-wider bg-blue-500/5 border border-blue-500/20 px-2.5 py-0.5 rounded-full">
                {proj.category}
              </span>
