    ...
    <section className="relative overflow-hidden py-24 md:py-32 bg-white border-b border-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 relative z-10 text-center space-y-6">
        ...
        >
          <a
            href="/services"
            className="btn-primary flex items-center gap-2 focus-visible:ring-2 focus-visible:ring-blue-500"
          >
          ...
          <a
            href="/courses"
            className="btn-outline focus-visible:ring-2 focus-visible:ring-slate-500"
          >
