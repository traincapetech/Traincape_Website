...
export default function PortfolioStats({ stats }) {
  ...
  const defaultStats = [
    { key: "projects", label: "Projects Delivered", value: "15+", color: "text-emerald-500", bg: "bg-emerald-500/10" },
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 text-center">
          {renderStats.map((stat, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-slate-50 backdrop-blur-sm border border-slate-200 rounded-xl p-4 md:p-5 flex flex-col items-center justify-center gap-2 hover:border-blue-500/20 hover:bg-white transition-all duration-300 shadow-sm"
              >
